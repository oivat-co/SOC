;;variables globales
;; para contabilizar a los individuos en cada estado
globals[
  num_inf
  num_ill
  num_heal
...
;;función para  representar el número de individuos en cada uno de los estados.
to count-states
  ifelse state = 0
  [set num_heal num_heal + 1]
  [ifelse state = max-state
  [set num_ill num_ill + 1]
  [set num_inf num_inf + 1]]
end

;;función para  representar el número de individuos en cada uno de los estados.
to do-plots
  set-current-plot "AC de la reacción de B-Z"
  set-current-plot-pen "sanos"
  plot num_heal
  set-current-plot-pen "infectados"
  plot num_inf
  set-current-plot-pen "enfermos"
  plot num_ill
end
...
"" ""
PENS
"sanos" 1.0 0 -16777216 true "" ""
"infectados" 1.0 0 -2674135 true "" ""
"enfermos" 1.0 0 -10899396 true "" ""
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>num_ill</metric>
    <metric>num_inf</metric>
    <metric>num_heal</metric>
    ...
    <enumeratedValueSet variable="max-state">
      <value value="200"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Das_exp" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="200"/>
    <metric>num_heal</metric>
